...
\paragraph{Plusieurs réseaux.} La taille des réseaux créés par une application
...
\noident Avec \SCAMP, pendant l'établissement d'une connexion WebRTC, non seulement le 
 message ne doit pas se perdre, mais les nœuds et arcs composants le chemin de
 l'annonce doivent rester disponibles. L'établissement d'une connexion est particulièrement vulnérable
 aux défaillances dans \SCAMP.
