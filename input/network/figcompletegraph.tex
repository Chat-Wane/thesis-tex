...
\draw (0.5*\X,-5-1*\Y) node[anchor=north, align=center]{2 nœuds; 2 arcs};
...
\draw (0.5*\X,-5-1*\Y) node[anchor=north, align=center]{3 nœuds; 6 arcs};
\end{scope}
...
\draw (0.5*\X,-5-1*\Y) node[anchor=north, align=center]{4 nœuds; 12 arcs};
\end{scope}
...
\draw (0.5*\X,-5-1*\Y) node[anchor=north, align=center]{5 nœuds; 20 arcs};
\end{scope}
