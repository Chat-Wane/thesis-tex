...
% document.  L'idée générale de \LSEQ consiste à accepter la perte de niveaux
% des chemins composants ses identifiants pour peu que les allocations suivantes
