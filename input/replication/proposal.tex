...
d'identifiants de taille variable.  Elle est composée de trois composants. Le
premier composant est un structure d'arbre dont l'arité maximale augmente avec
sa profondeur. Le second composant comprend deux sous-fonctions d'allocation
conçues pour gérer des comportements d'édition opposés. Le troisième composant
est une fonction assignant à chaque profondeur de l'arbre une sous-fonction
