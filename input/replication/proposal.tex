...
\end{inparaenum}
Individuellement, ces éléments n'arrivent pas à pourvoir des chemins de taille
satisfaisante. Utilisés simultanément, ils permettent à \LSEQ de générer des
identifiants de taille sous-linéaire.
