...
\draw (-1*\X, 1*\Y) -- node[anchor=west]{\DARKBLUE{1}} (0*\X, 2*\Y); % E
\draw ( 0*\X, 2*\Y) -- node[anchor=west]{\DARKBLUE{1}} (1*\X, 3*\Y); % R
\draw ( 1*\X, 3*\Y) -- node[anchor=west]{\DARKBLUE{1}} (2*\X, 4*\Y); % T
\draw ( 2*\X, 4*\Y) -- node[anchor=west]{\DARKBlUE{1}} (3*\X, 5*\Y); % Y
