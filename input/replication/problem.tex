...
\begin{problem}
  \TODO{ Soit $p_1.p_2\ldots p_x$ la liste de chemins générés par la série
    d'insertions $i_1.i_2\ldots i_x$, la tailles des identifiants progresse de
    manière sous-linéaire :}
  \begin{equation}
