...
\begin{problem}
  ...
  $p<_\mathcal{I}q$. La fonction \textsc{allocPath} doit allouer des chemins
  tels que : 
  \begin{equation}
...
d'insertions de gauche à droite et de droite à gauche.
...
d'insertions effectuées dans la séquence. À ce titre, aucun protocole
additionnel de relocalisation ayant pour objectif l'équilibrage de la structure
n'est nécessaire.
