...
créé grâce à des traces réelles. \TODO{Add \LSEQ in the mix.}

\paragraph{Description :} Logoot est configuré avec une base $2^{16}$. \LSEQ est
configuré avec une base de départ de $2^{8}$. Treedoc est configuré pour
utiliser sa méthode originelle -- son autre heuristique revenant plus ou moins à
la stratégie de Logoot. Les documents considérés sont des articles extraits de
...
artificiels. \TODO{Intégrer \LSEQ.}
