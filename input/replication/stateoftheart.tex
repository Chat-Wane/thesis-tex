...
\begin{figure}
  \begin{center}
    ...
    \caption{\label{repl:img:motivationlogoot} Taille des chemins allouées par
...
\begin{figure}
  \begin{center}
    ...
    \caption{\label{repl:img:motivationtreedoc} Taille des chemins allouées par
      ...
      montre la taille du chemin allouée à une ligne.}
  \end{center}
\end{figure}
...
ignorés) allouées par Treedoc. Un série d'insertions se succédant conduit à des
