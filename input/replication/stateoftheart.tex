...
chaque triple. Lors d'une insertion locale, les identifiants adjacents à la
position d'insertion sont récupérés. Ainsi l'identifiant $id$ du nouvel élément
inséré en position $i$ doit respecter
...
$id = [\langle 12,\, s_1,\,c_1 \rangle.\langle 10,\,s_1, c_3\rangle]$.  En
utilisant l'ordre lexicographique définit plus haut, nous obtenons bien
$id_{i-1} <_\mathcal{I} id <_\mathcal{i}$.
...
triplets. \TODO{Dans le pire cas}, la complexité spatiale de la structure est
