...
node{\DARKBLUE{\emph{signaling service}}} +(-35pt,-5pt) rectangle +(35pt,5pt);
...
(-1*\X,-2*\Y) node{$e_1$} +(-5pt,-5pt) rectangle +(5pt,5pt);
\draw[fill=white, very thick]
(0*\X, -3*\Y) node{$e_2$} +(-5pt,-5pt) rectangle +(5pt,5pt);
\draw[fill=white] (1*\X, -2*\Y) node{$e_3$} +(-5pt,-5pt) rectangle +(5pt,5pt);
