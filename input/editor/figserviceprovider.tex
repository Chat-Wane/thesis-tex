\begin{tikzpicture}[scale=1.3]
  ...
  \draw[fill=white](-0.5*\X, 0*\Y) 
  node[align=center]{\small serveur appartenant au fournisseur de services\\\small et hébergeant le document}
  +(-90pt,-10pt )rectangle+(90pt,10pt);
  ...
  \draw[fill=white](3*\X, 1*\Y) 
  node[align=center]{\small serveur appartenant au fournisseur de services\\\small et aidant à la transmission}
  +(-90pt,-10pt )rectangle+(90pt,10pt);
