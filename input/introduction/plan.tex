...
membre. Cette vue peut être utilisée afin de communiquer à l'ensemble du
...
globalité doit rester consistant sur la taille des vues partielles ainsi que sur
...
appartenant à la réplication dîte optimiste~\cite{demers1987epidemic,
  saito2005optimistic}. En particulier, les approches à transformés
opérationnels et les approches à structure de données sans résolution de
...
est bornée supérieurement selon le polylogarithme de la taille du document. Le
reste du chapitre s'attache à valider cette propriété.
