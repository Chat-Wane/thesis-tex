...
à son élaboration, donner ses avis, participer à sa rédaction.
%% Concrete exemple
Par conséquent, les dimensions que doivent supporter les éditeurs collaboratifs
ont largement augmentées.

Cependant, l'utilisation du web comme support à la collaboration apporte aussi
son lot de défauts. Son organisation éminemment centralisée, avec un serveur en
charge de l'ensemble des clients, pose les problèmes suivants :
