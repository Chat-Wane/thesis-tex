...
\item [\textbf{QR.}] \textbf{Quelle combinaison d'éléments permettent la
  ...
  \begin{inparaenum}[(i)]
  \item soit indestructibles~\cite{oster2006data}. L'opération de suppression
    se contente alors de cacher le caractère à l'utilisateur. Afin de supprimer ces
    caractères cachés et conserver de bonnes performances, un protocole de
    ramasse-miète réparti doit être exécuté
    régulièrement~\cite{abdullahi1998garbage}. Malheureusement, ce genre de
    protocoles s'avère extrêmement coûteux;
