...
indépendemment du nombre de répliques réel. \TODO{L'avantage d'un tel méchanisme
  est la facilité de raisonnement sur les données car leurs spécifications sont
  proches de celles proposées normalement.}
